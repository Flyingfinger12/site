...
if(isset($_GET['EntryID'])) //If looking at a specific Article
  {
    ...
    while($r=mysql_fetch_array($article2))
      {
         ...
         print "<A href='index.php'>Back to Main</a><br>";
         ...
         print "<br><input type='submit' value='Delete Entry' name='submit'>";
         print "&nbsp;<input type='submit' value='Edit Entry' name='edit'></form><br>";
         print "</td></tr>";
     }
    print "</table></td>";
    ...
    while($r=mysql_fetch_array($rateselect2))
      {
          ...
          print "<A href='mod.php?EntryID=$r[EntryID]'>$r[title]</a>($r[avgvotes])<br>";
      }
    ...
    while ($r2=mysql_fetch_array($readselect2))
      {
         print "<A href='mod.php?EntryID=$r2[EntryID]'>$r2[title]</a>($r2[timesviewed])<br>";
      }
    print "</td></tr></table><br><br>";
    print "<table border='1' cellpadding='4' cellspacing='0' bordercolor=$borderc>";
...
else if(isset($_POST['submit'])) //if user pressed search
{
    ...
    while($news=mysql_fetch_array($newsquery))
      {
        ...
        print "<tr><td>$news[shortdescription]<br><br><center><A href='mod.php?EntryID=$news[EntryID]'>Click here to read more</a>";
        print "</td></tr></table><br><br>";
      }
      ...
      if($f%$numentries==0)
   {
     ...
     $term=$searchterm;
      ...
      print "<A href='mod.php?searchterm=$term&submit=1&start=$d'>$g</a> ";
      $g++;
    }
    $d=$d+1;
    $f++;
...
if($f%$numentries==0)
  {
    ...
    print "<A href='mod.php?start=$d'>$g</a> ";
    $g++;
  }
$d=$d+1;
$f++;
